...
"[y]Arrow Keys[w] or [y]WASD[w]: Move or melee attack one step in the cardinal directions. Melee attacks draw one Soul on the Soul Wheel.\n[y]1-8[w]: Cast a spell corresponding to the chosen slot on the Soul Wheel.\n[y]C[w]: Enter Cursor mode to learn more about the 6 enemy types.\n[y]E[w]: Enter Caste mode to learn about and equip/unequip spells.\n[y]Z[w] or [y]X[w]: Reset the game.",
